...
public class CaminhoTest {
    ...
    public void testGetEnd1() {
        ...
        Caminho instance = new Caminho(end1, end2, 12, 45, 45);
    ...
    public void testSetEnd1() {
        ...
        Caminho instance = new Caminho(new Endereco("morada1", 15, 48, 48), new Endereco("morada2", 13, 56, 84), 12, 45, 45);
    ...
    public void testToString() {
        ...
        Caminho instance = new Caminho(new Endereco("morada1", 15, 48, 48), new Endereco("morada2", 13, 56, 84), 12, 45, 45);
        String expResult = "Caminho{end1=Endereco{morada=morada1, latitude=15.0, longitude=48.0, altitude=48.0}, end2=Endereco{morada=morada2, latitude=13.0, longitude=56.0, altitude=84.0}, roadResistanceCoefficient=12.0, velocidadeVento=45.0, direcaoVento=45.0}";
