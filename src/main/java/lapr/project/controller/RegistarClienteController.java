...
public class RegistarClienteController {
    ...
    public List<Cliente> getListaEstafetas() {
        return clienteDB.getLstClientes();
    }

    public void novoEstafeta(int nif, String nome, String email, String morada, double latitude, double longitude, double altitude, int numSegSocial, String password, int numCC, String dataValidade, int CCV) {
    ...
    public boolean registaEstafeta(Cliente cl) {
